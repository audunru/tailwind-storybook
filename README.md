...
This is a starter for [Tailwind CSS](https://tailwindcss.com/) and [Storybook](https://storybook.js.org/) v10 with [React](https://reactjs.org/) 19 components.

It's written in [TypeScript](https://www.typescriptlang.org/) 6 and uses [Vite](https://vitejs.dev/) 8. Tests are written with [Vitest](https://vitest.dev/) and [React Testing Library](https://testing-library.com/docs/react-testing-library/intro). Linting and formatting are handled by [Biome](https://biomejs.dev/). The [React Compiler](https://react.dev/learn/react-compiler) is enabled — components are automatically memoized.
